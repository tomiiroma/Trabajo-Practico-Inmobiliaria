...
public class ModificarInmueble implements Validacion{
	...
	public void modificarInmuebleInmuebleV(){
		...
		inmuebleControlador.addInmueble(new Inmueble(0, "Casa", "Excelente", "3", null, "Agronomia", "Corrientes", "Lindo Depto con buena vista", "30", "2", "1", 100, 50, 60000, true, false, false, false, false, "1200", null));
					...
					if(opcionSeleccionada.equals("Tipo de Inmueble")){
						String tipoInmueble = obtenerTipoInmueble();
							if (!tipoInmueble.equals("Departamento")) {
								...
								alturaDireccion = validarEntero("Ingrese la Altura de la calle del Inmueble");
								
								if(tipoInmueble.equalsIgnoreCase(inmuebleAmodificar.getTipo_inmueble()) && direccion.equalsIgnoreCase(inmuebleAmodificar.getDireccion())&&
										alturaDireccion.equalsIgnoreCase(inmuebleAmodificar.getAlturaDireccion())){
							        flag=true;
							...
							alturaDireccion = validarEntero("Ingrese la Altura de la calle del Departamento");
						...
						String alturaDireccionNueva = null;
						
						direccionNueva = validarCadena("Ingrese la calle donde se encuentra el Inmueble");
						alturaDireccionNueva = validarEntero("Ingrese la Altura de la calle del Inmueble");
	...
	public void modificarInmuebleInmuebleF1(){
		...
		inmuebleControlador.addInmueble(new Inmueble(1, "Casa", "Excelente", "3", null, "Agronomia", "Corrientes", "Lindo Depto con buena vista", "30", "2", "1", 100, 50, 60000, true, false, false, false, false, "1000", null));
		//      id_inmueble, tipo_inmueble, condicion, cantAmbientes, piso, barrio, direccion, descripcion, antiguedad, banio, dormitorio, superficie_cubierta, superficie_descubierta, precio, disponible, refaccionar, apto_mascota, patio, activo, alturaDireccion, nroDepto
					...
					if(opcionSeleccionada.equals("Tipo de Inmueble")){
						String tipoInmueble = obtenerTipoInmueble();
							...
							if(tipoInmueble.equalsIgnoreCase(inmuebleAmodificar.getTipo_inmueble()) && 
															direccion.equalsIgnoreCase(inmuebleAmodificar.getDireccion())&&
															alturaDireccion.equalsIgnoreCase(inmuebleAmodificar.getAlturaDireccion())&&
															piso.equalsIgnoreCase(inmuebleAmodificar.getPiso()) &&
															nroDepto.equalsIgnoreCase(inmuebleAmodificar.getNroDepto())){
	...
	//El gerente indica cambiar dentro de tipo de departamentom la direccion el nro de piso y el nro de depto de otro inmueble en este.

	public void modificarInmuebleInmuebleF2(){
		...
		inmuebleControlador.addInmueble(new Inmueble(1, "Departamento", "Excelente", "3", "2", "Agronomia", "Corrientes", "Lindo Depto con buena vista", "30", "2", "1", 100, 50, 60000, true, false, false, false, false, "1000", "5"));
		//      				id_inmueble, tipo_inmueble, condicion, cantAmbientes, piso, barrio, direccion, descripcion, antiguedad, banio, dormitorio, superficie_cubierta, superficie_descubierta, precio, disponible, refaccionar, apto_mascota, patio, activo, alturaDireccion, nroDepto
