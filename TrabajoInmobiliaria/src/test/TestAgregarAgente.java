...
public class TestAgregarAgente {
 ...
 public void AgregarAgenteVerdadero() {
	 ...
	 fecha_nacimiento = LocalDate.of(2000,8, 10);
	 	...
	 	if (gerente1.AgregarAgente2("Borrame","EnTestEliminarAgente", fecha_nacimiento , dni , 47502342, "Daniel@gmail.com", "asdasd20", 23213)==true) {
  ...
  public void AgregarAgentealt1nombre() {
 	 ...
 	 fecha_nacimiento = LocalDate.of(2000,8, 10);
 	 	...
 	 	if (gerente1.AgregarAgente2("Daniel el master","Fernandez", fecha_nacimiento , 42130100 , 47502342, "Daniel@gmail.com", "asdasd20", 23213)==true) {
  ...
  public void AgregarAgentealt2nombre() {
 	 ...
 	 fecha_nacimiento = LocalDate.of(2000,8, 10);
 	 	...
 	 	if (gerente1.AgregarAgente2("Daniel1","Fernandez", fecha_nacimiento , 42130100 , 47502342, "Daniel@gmail.com", "asdasd20", 23213)==true) {
  ...
  public void AgregarAgenteAlt4Apellido() {
 	 ...
 	 fecha_nacimiento = LocalDate.of(2000,8, 10);
 	 	...
 	 	if (gerente1.AgregarAgente2("Daniel","Fer nandez", fecha_nacimiento , 42130100 , 47502342, "Daniel@gmail.com", "asdasd20", 23213)==true) {
  ...
  public void AgregarAgenteAlt8Dni() {
 	 ...
 	 fecha_nacimiento = LocalDate.of(2000,8, 10);
 	 	...
 	 	if (gerente1.AgregarAgente2("Daniel","Fernandez", fecha_nacimiento , 421301002 , 47502342, "Daniel@gmail.com", "asdasd20", 23213)==true) {
  ...
  public void AgregarAgenteAlt9Dni() {
 	 ...
 	 fecha_nacimiento = LocalDate.of(2000,8, 10);
 	 	...
 	 	if (gerente1.AgregarAgente2("Daniel","Fernandez", fecha_nacimiento , -1000000 , 47502342, "Daniel@gmail.com", "asdasd20", 23213)==true) {
  ...
  public void AgregarAgenteAlt10telefono() {
 	 ...
 	 fecha_nacimiento = LocalDate.of(2000,8, 10);
 	 	...
 	 	if (gerente1.AgregarAgente2("Daniel","Fernandez", fecha_nacimiento , 42131002 , 475023422, "Daniel@gmail.com", "asdasd20", 23213)==true) {
  ...
  public void AgregarAgenteAlt11telefono() {
 	 ...
 	 fecha_nacimiento = LocalDate.of(2000,8, 10);
 	 	...
 	 	if (gerente1.AgregarAgente2("Daniel","Fernandez", fecha_nacimiento , 42131002 , -1234567 , "Daniel@gmail.com", "asdasd20", 23213)==true) {
  ...
  public void AgregarAgenteAlt14AgenteRepetido() {
 	 ...
 	 fecha_nacimiento = LocalDate.of(2000,8, 10);
 	 	...
 	 	if (gerente1.AgregarAgente2("Daniel","Fernandez", fecha_nacimiento , 42138038 , 47502342, "Daniel@gmail.com", "asdasd23", 23213)==true) {
